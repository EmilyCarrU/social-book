...
App.DecadeView = Backbone.View.extend({
  ...
  events: {
    "click .target__decade_toc" : "expandItemClick",
    "tap .target__decade_toc" : "expandItemTap",
...
App.YearView = Backbone.View.extend({
  ...
  events: {
    "click": "preventDefault",
    "tap .target__chapterItem": "launchTap",
    "click .target__chapterItem": "launchClick",
