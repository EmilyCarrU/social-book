...
App.Section = Backbone.Model.extend({
  ...
  urlRoot: 'http://book.hyko.org/api',
...
App.SectionsView = Backbone.View.extend({
  ...
  initialize: function() {
    console.log("initialize section list view")
  },
  render : function() {
...
App.SectionView = Backbone.View.extend({
  ...
  tagName: 'li',
  className: 'section topcoat-list__item',


  events: {
    "click": "test",
    "click .target--section" : "expandSectionClick",
    "tap .target--section" : "expandSectionTap",
    "openPanel .target--section" : "expandSectionPinch",
    "closePanel .target--section" : "colapseSectionPinch"
  },

  initialize: function(){
    // this.model.on('change', App.SectionsView.render);
    this.model.on('destroy hide', this.remove, this);
  },
...
App.SubChapterView = Backbone.View.extend({
  ...
  render: function() {
    ...
    return this.$el.prepend('<section class="subchapter-wrapper">' + this.model.toJSON().content + '</div>'); // Obviously there is a better way to do this, but I don’t what’s best right now
  },
...
App.CommentsView = Backbone.View.extend({
  ...
  // tagName : "ol",
  // className : "comment-list" // This doesn’t seem to create an element, list is appended to ul.comment-list template
  events: {
...
App.CommentView = Backbone.View.extend({
  ...
  tagName: "li",
  className: "comment topcoat-list__item",
...
App.Router = new (Backbone.Router.extend({
  routes: {
    "": "initialize", // this should be index, terrible for performance right now but it works
    "section/:id": "viewSection",
    "chapter/:slug": "showChapter"
  },
  ...
  index: function(){
    ...
    console.log("I don’t know how to re-render all the sections here");
  ...
  showChapter: function(slug){
    var chapter = this.chapter.get(slug);
    chapter.select();
  },
  start: function() {
