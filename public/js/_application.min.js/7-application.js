...
App.SectionView = Backbone.View.extend({
  ...
  events: {
    "click .target--section" : "expandItemClick",
    "tap .target--section" : "expandItemTap",
    "openPanel .target--section" : "expandItemPinch",
    "closePanel .target--section" : "colapseItemPinch"
  },
  ...
  expandItemClick : function(e){
    ...
    if (window.App.optionClickDev != false) {
      ...
      // diveWrapper.addClass('is-open dive--tease');
      // window.setTimeout(function(){$(diveWrapper).removeClass("is-open dive--tease");}, 100);
      diveWrapper.toggleClass('is-open');
    }
  },
...
App.ChapterView = Backbone.View.extend({
  ...
  events: {
    "click .target--chapter" : "expandItemClick",
    "tap .target--chapter" : "expandItemTap",
    "openPanel .target--chapter" : "expandItemPinch",
    "closePanel .target--chapter" : "colapseItemPinch"
  },
